        ...
        <section className="bg-gradient-to-br from-primary to-primary/80 text-primary-foreground py-16 md:py-24">
          <div className="container">
            ...
            <p className="text-lg opacity-90 max-w-2xl mb-4">
              สำนักงานกฎหมายเกรียงศักดิ์ ให้บริการทนายความในกรุงเทพฯ (สำโรงเหนือ สุขุมวิท) รับว่าความคดีแพ่ง คดีอาญา คดีครอบครัว และคดีสัญญา โดยให้คำปรึกษาและประเมินแนวทางคดีอย่างเป็นระบบ
            </p>
