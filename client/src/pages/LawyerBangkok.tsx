...
const PAGE_META = {
  title: "ทนายความทั่วประเทศ รับว่าความคดีแพ่ง อาญา ครอบครัว | สำนักงานกฎหมายเกรียงศักดิ์",
  description:
    "ทนายความทั่วประเทศ (สำโรงเหนือ สุขุมวิท) รับว่าความคดีแพ่ง อาญา ครอบครัว ให้คำปรึกษาโดยตรง นัดหมายได้ทันที",
};
        ...
        <section className="bg-gradient-to-br from-primary to-primary/80 text-primary-foreground py-16 md:py-24">
          <div className="container">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              ทนายความทั่วประเทศ รับว่าความคดีแพ่ง อาญา ครอบครัว
            </h1>
